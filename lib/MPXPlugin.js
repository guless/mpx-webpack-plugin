...
module.exports = class MPXPlugin {
    ...
    apply( compiler ) {
        ...
        compiler.hooks.beforeCompile.tap(PLUGIN_NAME, ( params ) => {
            const miniprogramModuleFactory = new MPXModuleFactory(this.platform, compiler.resolverFactory);
        ...
        compiler.resolverFactory.hooks.resolveOptions
            ...
            .tap(PLUGIN_NAME, resolveOptions => {
                return Object.assign({ fileSystem: compiler.inputFileSystem }, compiler.options.resolve, resolveOptions);
            });
            
        compiler.resolverFactory.hooks.resolver
            .for("miniprogram")
            .tap(PLUGIN_NAME, resolver => {
                new MPXResolverPlugin("before-raw-file", this.platform, "resolved").apply(resolver);
            });
    }
}