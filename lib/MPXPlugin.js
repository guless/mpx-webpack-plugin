...
const MPXTargetPlugin = require("./MPXTargetPlugin");
const MPXLoadChunksPlugin = require("./MPXLoadChunksPlugin");
const MPXLoaderOptionsPlugin = require("./MPXLoaderOptionsPlugin");
...
module.exports = class MPXPlugin {
    ...
    apply( compiler ) {
        ...
        /// 小程序编译目标。
        new MPXTargetPlugin().apply(compiler);
        
        /// 小程序 loader 上下文。
        new MPXLoaderOptionsPlugin(this.platform).apply(compiler);
        
        /// 加载由 splitChunks 分离的公共区块(chunks)。
        new MPXLoadChunksPlugin(this.chunks).apply(compiler);
    }
}

module.exports.loaders = require("./loaders");
module.exports.platforms = require("./platforms");